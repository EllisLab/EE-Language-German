...
'file_undo_remove' => 'Löschen wiederherstellen',

'directory_no_access' => 'Sie haben keinen Zugriff auf das Verzeichnis das diesem Feld zugeteilt wurde',

'directory' => 'Verzeichnis:',

'rel_ft_options' => 'Beziehungsfeld Optionen',

'rel_ft_configure' => 'Beziehungen konfigurieren',

'rel_ft_configure_subtext' => 'Zu welchem Inhalt wollen Sie einen Bezug?',
...
'rel_ft_authors' => 'Begrenze Einträge auf Autor',

'rel_ft_statuses' => 'Begrenze Einträge auf Status',

'rel_ft_limit_left' => 'Begrenze Einträge auf',

'rel_ft_limit_right' => 'gefundene',

'rel_ft_limit_subtext' => 'leer lassen um ALLE Einträge zuzulassen',
...
'rel_ft_allow_multi_subtext' => 'Autoren werden mehr als einen Eintrag für die Beziehung auswählen können',

'file_ft_options' => 'File Feld-Optionen',

'file_ft_configure' => 'Allgemeine Feld-Optionen',

'file_ft_configure_subtext' => 'Weitere Angabe wie das Feld sich verhalten soll',

'file_ft_content_type' => 'Erlaubte Dateitypen',

'file_ft_allowed_dirs' => 'Erlaubte Verzeichnisse',

'file_ft_configure_frontend' => 'Frontend Optionen',

'file_ft_configure_frontend_subtext' => 'Ändere das verhalten wenn in einem {channel:form} Tag',

'file_ft_show_files' => 'Zeige bestehende Dateien?',

'file_ft_show_files_subtext' => 'Autoren können eine bestehende Datei aus einem Dropdown wählen',

'file_ft_limit_left' => 'Begrenze Dateien auf',

'file_ft_limit_right' => 'gefundene',

'file_ft_limit_files_subtext' => 'Leer lassen um ALLE zu zeigen',

'file_ft_select_existing' => 'Wähle eine bestehende Datei',

'grid_options' => 'Grid-Feld Optionen',

'grid_min_rows' => 'Minimum Zeilen',

'grid_min_rows_desc' => 'Das Minimum an Daten-Zeilen für dieses Grid',

'grid_max_rows' => 'Maximum Zeilen',

'grid_max_rows_desc' => 'Das Maximum an Daten-Zeilen für dieses Grid',

'grid_config' => 'Konfiguriere Grid',
...
'grid_col_required' => 'bedingt?',

'grid_col_searchable' => 'durchsuchbar?',
...
'grid_col_name_reserved' => 'Eine oder mehrere Spalten haben einen Namen der für andere Template-Funktionalität Verwendung findet.',
...
'grid_add_row' => 'Zeile anfügen',

'grid_add_column' => 'Spalte anfügen',

'grid_delete_row' => 'Zeile löschen',

'grid_delete_column' => 'Spalte löschen',
