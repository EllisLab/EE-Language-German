...
'config_editor' => 'Konfiguration Datei-Manager',

'php_info' => 'PHP Info',

'recount_stats' => 'Statistik neu zählen',

'search_and_replace' => 'Suchen und Ersetzen',

'sql_manager' => 'SQL Manager',

'clear_caching' => 'Daten-Cache leeren',

'view_throttle_log' => 'Drosselung Log zeigen',

'view_search_log' => 'Suchbegriffe Log zeigen',

'view_email_logs' => 'E-Mail Konsole Log zeigen',

'view_cp_log' => 'Control Panel Log zeigen',

'view_developer_log' => 'Developer Log zeigen',
...
'no_throttle_logs' => 'Das System drosselt im Moment keine IPs.',

'throttling_disabled' => 'Drosselung nicht aktiv',
...
'file_saved' => 'Die übersetzte Datei wurde gespeichert in system/expressionengine/translations/ ',
...
'deprecated_function' => 'Veraltete Funktion %s aufgerufen',

'deprecated_on_line' => 'in %s auf Zeile %d',

'deprecated_since' => 'Veraltet seit %s.',

'deprecated_use_instead' => 'Bitte %s stattdessen benützen',

'deprecated_template' => 'Von Template Tag %s in %s.',

'deprecated_snippets' => 'Dieser Tag könnte von einem dieser Snippets geparsed worden sein: %s',

'deprecated_hook' => 'Veralteter Extension Hook aufgerufen durch die folgende Erweiterung  (Class::method) %s',

'deprecation_detected' => 'Das System hat eine Erweiterung entdeckt die veralteten Code benutzt, der womöglich nicht mehr läuft oder dem System Probleme bereiten kann.',

'dev_log_view_report' => 'Bericht zeigen',

'dev_log_help' => 'Was bedeutet das?',

'deprecated_meaning' => 'Das System hat eine Erweiterung entdeckt die veralteten Code benutzt, der womöglich nicht mehr läuft oder dem System Probleme bereiten kann. Es bedeutet, dass eine installierte Erweiterung einen Teil des ExpressioinEngine Kerns anspricht, der in Zukunft von EllisLab entfernt werden wird, um die Qualität des Produkts zu verbessern. ',
